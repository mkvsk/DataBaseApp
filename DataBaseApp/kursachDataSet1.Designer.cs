...
namespace DataBaseApp.kursachDataSet1TableAdapters {
...
SELECT id, first_name, second_name, middle_name, phone_number_main, phone_number_additional, registration_date, activity, tariff_plan FROM abonents WHERE (id = @id)";
        ...
        public virtual int Fill(kursachDataSet1.abonentsDataTable dataTable) {
        ...
        public virtual kursachDataSet1.abonentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            kursachDataSet1.abonentsDataTable dataTable = new kursachDataSet1.abonentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(kursachDataSet1.abonentsDataTable dataTable) {
